    ...
    return (
      ...
      >
        ...
        <div className="grid  grid-cols-1 lg:grid-cols-3 gap-12 items-center">
          ...
          />
          <ProjectCard
            projectTitle="WebApp Course"
            description="University course about web applications development with JavaScript & it's libraries"
            usedTechnologies={["react", "js", "tailwindcss", "css"]}
            projectImage={uncpLogo}
          ...
          <div className=" w-full max-w-[26rem] hover:scale-105 relative p-5 mx-5 hover:shadow-xl  rounded-xl duration-200 bg-white ">
            More Projects
            <hr className="my-3 h-px border-t-0 bg-transparent bg-gradient-to-r from-transparent via-neutral-400 to-transparent opacity-50" />
            <div className="p-6 ">
              ...
              <Button
                size="lg"
                fullWidth={true}
                className="px-12 py-2 flex gap-3  justify-center items-center normal-case bg-[#403d39] text-white tracking-wider  rounded-xl"
              >
                <a
