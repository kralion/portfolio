...
import profilePic from '../assets/images/profiles/32.jpg'
    ...
    return (
        <section id='testomonial' className="text-gray-600 font-Source-Sans-Pro">
            <div className="container flex flex-col gap-5 px-5 py-24 mx-auto">
                <span className="bg-[#eb5e28] w-[102px] text-center  px-3 my-5 text-gray-100 font-semibold py-1 self-center pb-2 rounded-full">Testimonial</span>
                <div className="flex flex-wrap -m-4">

                    <div data-aos="fade-in" data-aos-delay="200" data-aos-duration="1500" className="p-4 md:w-1/2 w-full">
                        <div className="h-full bg-gray-200/20 p-8 shadow-md rounded-xl">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="gray" className="block w-5 h-5 text-gray-400 mb-4" viewBox="0 0 975.036 975.036">
                            ...
                            <a href='' className="inline-flex items-center ">
                                <img alt="testimonial" src={profilePic} className="w-12 h-12 rounded-full flex-shrink-0 object-cover object-center" />
